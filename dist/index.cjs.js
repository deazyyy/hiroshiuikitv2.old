...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true, className: "connctlinkmodal" },
                        ...
                        React__default['default'].createElement("nav", { className: "navigation__nav" },
                            React__default['default'].createElement("ul", { className: "navigation__list" },
                                React__default['default'].createElement("li", { className: "navigation__item" },
                                    React__default['default'].createElement("a", { href: "#", className: "navigation__link" }, "melody farm")),
                                React__default['default'].createElement("li", { className: "navigation__item" },
                    ...
                    React__default['default'].createElement("div", { className: "connectrowouter" },
                        React__default['default'].createElement("div", { className: "dropdown" },
                            ...
                            React__default['default'].createElement("ul", { className: "dropdown__items" },
                                ...
                                React__default['default'].createElement("li", null,
                                    " ",
                                    React__default['default'].createElement("a", { target: "_blank", "aria-label": "Telegram", href: "https://t.me/MozartFinance" },
                                        React__default['default'].createElement("i", { className: "fas fa-paper-plane" }))),
                                React__default['default'].createElement("li", null,
                                    React__default['default'].createElement("a", { target: "_blank", "aria-label": "Twitter", href: "https://twitter.com/MozartFinance" },
                                        React__default['default'].createElement("i", { className: "fab fa-twitter" }))))),
                        React__default['default'].createElement("a", { href: "https://exchange.mozartfinance.io", className: "nav_link outlineBtn" }, "Exchange"),
        ...
        React__default['default'].createElement("div", { className: "menutopdesk menufooter" },
            React__default['default'].createElement("div", { className: "menutopdeskinner" },
                React__default['default'].createElement("div", null,
                    React__default['default'].createElement(Logo$1, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: "https://mozartfinance.io" }),
                    React__default['default'].createElement("div", { className: "logoName" }, "HIROSHI")),
